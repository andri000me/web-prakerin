            ...
            <div class="col-md-12 ml-4">
                <form action="<?= base_url('guru/kejadian') ?>" method="POST">
                    <div class="form-group">
                        <h3 style="text-transform: uppercase; border-bottom: 2px solid #fff; width: 50%; color: white; margin-bottom: 5%;">Cari nama siswa</h3>
                        <div class="row">
                            ...
                            <tbody class="list">
                                ...
                                foreach ($kejadian as $a) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('guru/komentar/') . $a->id_siswa; ?>" class="btn-sm btn-info"><i class="ni ni-chat-round"></i> Komentar</a>
                                        </td>
