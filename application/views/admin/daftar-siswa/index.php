...
<?php if ($this->session->flashdata('update_siswa') == TRUE) : ?>
  <script>
    Swal.fire({
      type: 'success',
      title: 'Update Berhasil!',
      text: '<?php echo $this->session->flashdata('update_siswa') ?>'
    });
  </script>
  <?php
  $url = $_SERVER['REQUEST_URI'];
  ...
  <div class="header bg-gradient-info pb-8 pt-5 pt-md-8">
    <div class="container-fluid">
      <div class="header-body">
        <form action="<?php echo base_url('admin/daftarSiswa') ?>" method="post">
          <div class="row">
            ...
            <div class="col-md-4 ml--6">
              <a href="<?php echo base_url('admin/tambahSiswa') ?>" class="btn btn-default text-white" type="submit" data-toggle="tooltip" data-placement="top" title="Tambah Siswa">
                  ...
                  <tbody class="list">
                    ...
                    foreach ($siswa as $s) : ?>
                      <tr>
                        ...
                        <td class="completion">
                          <div class="d-flex align-items-center">
                            <span class="mr-2"><?php echo $s->user ?></span>
                          </div>
                        </td>

                        <td class="completion">
                          <div class="d-flex align-items-center">
                            <span class="mr-2"><?php echo $s->pass ?></span>
                          </div>
                        </td>
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                              <a class="dropdown-item" href="<?php echo base_url('admin/editSiswa/') . $s->id_siswa ?>">Edit</a>
                              <a class="dropdown-item" href="<?php echo base_url('admin/deleteSiswa/') . $s->id_siswa ?>" onclick="return confirm('Yakin?')">Hapus</a>
